...
import copy
from Chang1 import KECC, subgraph

def MinimalSubgraph(G, k, d, X, count=None):
    """
    implementation of the Mincoh algorithm on k-EC index
    :param G: a k-EC graph
